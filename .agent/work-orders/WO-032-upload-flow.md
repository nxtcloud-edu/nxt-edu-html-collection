...
상태: 완료 (2026-07-17, 검증자 Claude — npm test 46/46·Chrome 실측·curl API·main 머지·사용자 명시 승인 후 Lambda 배포·프로덕션 정적 실측(cohort upload-link·upload.html location.assign·URLSearchParams) 통과)
