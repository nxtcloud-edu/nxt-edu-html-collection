...
- Branch: `main`, Phase 1 설계 커밋 완료. origin/main보다 1커밋 앞섬.
- Worktree: Phase 1 상태 기록을 같은 커밋에 반영한 뒤 clean 확인 예정. 런타임 코드는 변경하지 않음.
...
## Next safe action
1. Phase 2: 운영 동작을 바꾸지 않는 domain normalizer와 repository 계약을 테스트 우선으로 도입한다.
